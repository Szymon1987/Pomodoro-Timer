...
//        userDefaults.set(timerCounting, forKey: COUNTING_KEY)
    ...
    // change the code  below, it is working but it isn't efficient
    ...
    private func setupTopLabelsStackView() {
        ...
        addSubview(intervalsBackgroundView)
        intervalsBackgroundView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 15).isActive = true
        intervalsBackgroundView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -15).isActive = true
        intervalsBackgroundView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 30).isActive = true
        intervalsBackgroundView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.08).isActive = true
